  ...
  return (
    <>
      <header>
        <nav className="navbar navbar-top-default navbar-expand-lg navbar-simple nav-line">
          <div className="container">
            <Link to="#slider-section" title="Logo" className="logo scroll">
              <img
                src="/vendor/moonitemplate/images/mooni_logo.png"
                alt="logo"
            ...
            <div className="collapse navbar-collapse" id="megaone">
              <div className="navbar-nav ml-auto">
                <Link className="nav-link scroll line" to="#slider-section">
                  Home
                </Link>
                <Link className="nav-link line" to="/stake">
                  Stake
                </Link>
                <Link className="nav-link line" to="/balance">
                  Farming
                </Link>
                <Link
                  to="https://exchange.pancakeswap.finance/#/swap?inputCurrency=0xed438051437c22a9ef249b68c7e292435fe8b858"
                  target="_blank"
                  className="btn btn-medium btn-rounded btn-pink nav-button"
                >
                  Buy
                </Link>
              </div>
          ...
          <div className="navigation-toggle">
            <ul className="slider-social toggle-btn my-0">
              <li>
                <Link className="sidemenu_btn" id="sidemenu_toggle">
                  <span></span>
                  <span></span>
                  <span></span>
                </Link>
          ...
          <div className="inner-wrapper">
            <nav className="side-nav w-100">
              <Link
                to="#slider-section"
                title="Logo"
                className="logo scroll navbar-brand"
              >
                <img
                  src="/vendor/moonitemplate/images/mooni_logo.png"
                  alt="logo"
              ...
              <ul className="navbar-nav text-capitalize">
                <li className="nav-item">
                  <Link className="nav-link scroll" to="#slider-section">
                    Home
                  </Link>
                </li>
                <li className="nav-item">
            ...
            <div className="side-footer w-100">
              <ul className="social-icons-simple">
                <li>
                  <Link
                    className="social-icon wow fadeInRight"
                    to="https://twitter.com/moonidefi"
                ...
                <li>
                  <Link
                    className="social-icon wow fadeInLeft"
                    to="https://t.me/moonichat"
                    data-wow-delay="300ms"
                  >
        ...
        <div
          className="quote-content hidden animated-modal stake-modal"
          id="animatedModal"
        >
          <div className="title mb-5">
            <h2>
              <span className="text-pink js-rotating">$, $</span> 100.00
            </h2>
          </div>
          <form className="contact-form" id="modal-contact-form-data">
            <div className="row">
              ...
              <div className="col-md-12" style={{ marginTop: "20px" }}>
                <Link
                  to="stake.html"
                  className="btn btn-medium btn-rounded btn-pink modal_contact_btn"
                  id="stake_submit_btn"
                >
                  Stake
                </Link>
      ...
      <div id="slider-section" className="slider-section">
        ...
        >
          <div
            id="vertical-bullets"
            className="rev_slider fullwidthabanner white vertical-tpb"
            data-version="5.4.1"
          >
            <ul>
              <li
              ...
              >
                <img
                  src="/vendor/moonitemplate/images/background_header.webp"
                  alt=""
                ...
                <div
                  ...
                  data-splitout="none"
                >
                  <p className="text-white alt-font font-18">
                    MOONI DeFi is the incubator based on Binance Smart chain
                    with <br />
                    innovative product launches, where community <br />
                    gets rewarded in ecosystem tokens
                  </p>
                </div>
                <div
                  className="tp-caption tp-resizeme"
                ...
                >
                  <Link
                    to="/"
                    target="_blank"
                    className="btn btn-medium btn-rounded btn-trans"
                  >
                    <i className="fab fa-paperclip"></i>Whitepaper
                  </Link>
                  <Link
                    to="/"
                    target="_blank"
        ...
        <ul className="social-icons social-icons-simple revicon white d-none d-md-block d-lg-block">
          <li className="d-table">
            <Link to="https://twitter.com/moonidefi" className="social-icon">
              <i className="fab fa-twitter"></i>{" "}
            </Link>{" "}
          </li>
          <li className="d-table">
            <Link to="https://t.me/moonichat" className="social-icon">
              <i className="fab fa-telegram-plane"></i>{" "}
            </Link>{" "}
          </li>
        </ul>
        ...
        <div className="container">
          <div className="row">
            <div
              ...
              data-wow-delay="300ms"
            >
              <p className="text-pink fontWeight-200 font-20">
                Binance Smart Chain DeFi
              </p>
              <h1 className="main-font fontWeight-600 text-white">
                What is M O O N I?
              </h1>
            </div>

            <div
              className="col-12 col-lg-6 m-ipad wow fadeInRight"
              data-wow-delay="300ms"
            >
              <div className="ml-md-4 pl-md-2 fontWeight-200 text-grey font-18">
                <p>
                  Mooni DeFi is the incubator based on Binance Smart chain with
                  innovative product launches, where community gets rewarded in
                  ecosystem tokens. Our focus is to build innovative DeFi
                  products for BSC and support fair launches for the community.
                  The ecosystem consists of four main offerings initially, here
                  are the products with launch dates.
                </p>
              </div>
            </div>
          </div>
          <div className="row about-margin">
            <div className="col-md-4 col-sm-12">
              <div
                className="about-box center-block bg-green wow zoomIn"
            ...
            <div className="col-md-4 col-sm-12">
              ...
              >
                ...
                <p className="text-grey fontWeight-200 font-20">
                  After each transaction, the 4% is automatically added to LP.
                  That is why the LP increases automatically.
                </p>
              </div>
            </div>
            <div className="col-md-4 col-sm-12">
              ...
              >
                ...
                <p className="text-grey fontWeight-200 font-20">
                  4% of every transaction redistributed to holders. Earn yield
                  by just holding! Already burned 50% M O O N I
                </p>
              </div>
            </div>
          </div>
          <div
            className="d-flex justify-content-center wow bounceInLeft"
            data-wow-delay="300ms"
          >
          </div>
          <br />
            ...
            <div className="row">
              ...
              >
                ...
                >
                  <img
                    className="saf"
                    src="/vendor/moonitemplate/images/mooni_launch.png"
                    alt="About-Us"
                  />
                </div>
              </div>
              ...
              >
                <div className="ml-md-4 pl-md-2 fontWeight-200 text-grey font-18">
                  ...
                  <p>
                    Mooni token of Mooni deFi ecosystem, holding Mooni will give
                    users voting rights for the development of ecosystem, also
                    when you trade, each transaction has a 8% fee applied, which
                    will be redistributed instantly to all holders of the Mooni
                    token.​ The great thing about this mechanism is that holders
                    will be earning rewards without staking or any interaction
                    with smart contract. Mooni is also a governance plus utility
                    token, using which the community can exercise rights on
                    development of projects from our ecosystem.
                  </p>
                </div>
              </div>
            </div>
        ...
        <div className="row" style={{ backgroundColor: "#ddd" }}>
          <div className="col-12" style={{ textAlign: "center" }}>
            <img
              ...
              src="/vendor/moonitemplate/images/Roadmap.webp"
              alt="Roadmap"
            />
          </div>
        </div>
